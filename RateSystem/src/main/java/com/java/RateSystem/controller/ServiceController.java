...
//
//    @GetMapping("")
//    List<Services> getAllServiceName() {
//        return serviceRepository.findAll();
//    }
//
//    @GetMapping("/{id}")
//    ResponseEntity<ResponseObject> findById(@PathVariable Long ServiceId){
//        Optional<Services> foundProduct = serviceRepository.findById(ServiceId);
...
//    //insert data
////    @PostMapping("/insert")
////    ResponseEntity<ResponseObject> insertProduct(@RequestBody Services newService){
////        Optional<Services> foundService = serviceRepository.findByServiceName(newService.getServiceName().trim());
...
//    //Update data
//    @PutMapping("/{id}")
//    ResponseEntity<ResponseObject> updateService(@RequestBody Services newService, @PathVariable Long ServiceId){
//        Services updateService =  serviceRepository.findById(ServiceId)
//                .map(service -> {
